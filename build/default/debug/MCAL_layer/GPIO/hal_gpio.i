...
# 1 "MCAL_layer/GPIO/../../MCAL_layer/device_config.h" 1
# 16 "MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/GPIO/hal_gpio_cnfg.h" 1
...
# 16 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_initialize(const pin_config_t* _pin_config)
{
    Std_ReturnType ret = (Std_ReturnType) 0x00;
    if(_pin_config == ((void*)0) || _pin_config->pin > 8 -1)
    {
...
# 71 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t* _pin_config , direction_t *dirc_status)
{
    Std_ReturnType ret = (Std_ReturnType) 0x01;
    if(_pin_config == ((void*)0) || dirc_status == ((void*)0) || _pin_config->pin > 8 -1)
    {
        ret = (Std_ReturnType) 0x00;
    }
    else
    {
        *dirc_status = (*tris_registers[_pin_config->port] & (1 << _pin_config->pin));
        ret = (Std_ReturnType) 0x01;
    }
    return ret;
}
...
{
    Std_ReturnType ret = (Std_ReturnType) 0x01;
    if(_pin_config == ((void*)0) || _pin_config->pin > 8 -1 || logic == ((void*)0))
    {
        ret = (Std_ReturnType) 0x00;
    }
    else
    {
        *logic = (*port_registers[_pin_config->port] & (1 << _pin_config->pin));
        ret = (Std_ReturnType) 0x01;
    }
    return ret;
}
# 148 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t* _pin_config)
{
    Std_ReturnType ret = (Std_ReturnType) 0x01;
    if(_pin_config == ((void*)0) || _pin_config->pin > 8 -1)
...
# 217 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_write_logic(port_index_t port , uint8 logic)
{
    Std_ReturnType ret = (Std_ReturnType) 0x01;
    if(port > 5 -1)
...
# 263 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port)
{
    Std_ReturnType ret = (Std_ReturnType) 0x01;
    if(port > 5 -1)
