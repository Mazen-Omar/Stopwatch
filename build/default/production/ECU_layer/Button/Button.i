...
# 1 "ECU_layer/Button/../../MCAL_layer/GPIO/../../MCAL_layer/device_config.h" 1
# 16 "ECU_layer/Button/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/Button/../../MCAL_layer/GPIO/hal_gpio_cnfg.h" 1
...
# 38 "ECU_layer/Button/Button.c"
Std_ReturnType Button_read(const Button_t* btn ,Button_state_t* _st)
{
    Std_ReturnType ret = (Std_ReturnType) 0x00;
    logic_t button_logic = GPIO_LOGIC_LOW;
    if(btn == ((void*)0) || _st == ((void*)0))
    {
        ret = (Std_ReturnType) 0x00;
    }
    else
    {
        ...
        {
            if(button_logic == GPIO_LOGIC_LOW)
            {
                *_st = BUTTON_RELEASED;
            }
            else
