...
# 1 "./ECU_layer/LED/../../MCAL_layer/GPIO/hal_gpio_cnfg.h" 1
...
# 1 "./ECU_layer/Button/Button_cnfg.h" 1
...
# 11 "./ECU_layer/Relay/Relay.h"
# 1 "./ECU_layer/Relay/Relay_cnfg.h" 1
...
# 17 "./ECU_layer/DC_motor/DC_motor.h"
typedef struct
{
    uint8 motor_port : 4;
    uint8 motor_pin : 3;
...
# 1 "./ECU_layer/7_segment/segment.h" 1
# 11 "./ECU_layer/7_segment/segment.h"
# 1 "./ECU_layer/7_segment/segment_cnfg.h" 1
# 11 "./ECU_layer/7_segment/segment.h" 2
...
# 1 "./ECU_layer/Keypad/keypad_cnfg.h" 1
...
typedef struct
{
    ...
    pin_config_t keypad_columns_pin[4];
}keypad_t;
...
void application_initialize();
Std_ReturnType ret;
Button_state_t start_state;
Button_state_t stop_state;
Button_state_t reset_state;
Button_state_t pause_state;
Button_state_t speed_state;
