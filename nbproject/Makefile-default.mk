...
FINAL_IMAGE=${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ECU_layer/7_segment/segment.c ECU_layer/Button/Button.c ECU_layer/DC_motor/DC_motor.c ECU_layer/LED/ecu_led.c ECU_layer/project_1/project1.c ECU_layer/Relay/Relay.c MCAL_layer/GPIO/hal_gpio.c MCAL_layer/device_config.c application.c ECU_layer/Keypad/keypad.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ECU_layer/7_segment/segment.p1 ${OBJECTDIR}/ECU_layer/Button/Button.p1 ${OBJECTDIR}/ECU_layer/DC_motor/DC_motor.p1 ${OBJECTDIR}/ECU_layer/LED/ecu_led.p1 ${OBJECTDIR}/ECU_layer/project_1/project1.p1 ${OBJECTDIR}/ECU_layer/Relay/Relay.p1 ${OBJECTDIR}/MCAL_layer/GPIO/hal_gpio.p1 ${OBJECTDIR}/MCAL_layer/device_config.p1 ${OBJECTDIR}/application.p1 ${OBJECTDIR}/ECU_layer/Keypad/keypad.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ECU_layer/7_segment/segment.p1.d ${OBJECTDIR}/ECU_layer/Button/Button.p1.d ${OBJECTDIR}/ECU_layer/DC_motor/DC_motor.p1.d ${OBJECTDIR}/ECU_layer/LED/ecu_led.p1.d ${OBJECTDIR}/ECU_layer/project_1/project1.p1.d ${OBJECTDIR}/ECU_layer/Relay/Relay.p1.d ${OBJECTDIR}/MCAL_layer/GPIO/hal_gpio.p1.d ${OBJECTDIR}/MCAL_layer/device_config.p1.d ${OBJECTDIR}/application.p1.d ${OBJECTDIR}/ECU_layer/Keypad/keypad.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ECU_layer/7_segment/segment.p1 ${OBJECTDIR}/ECU_layer/Button/Button.p1 ${OBJECTDIR}/ECU_layer/DC_motor/DC_motor.p1 ${OBJECTDIR}/ECU_layer/LED/ecu_led.p1 ${OBJECTDIR}/ECU_layer/project_1/project1.p1 ${OBJECTDIR}/ECU_layer/Relay/Relay.p1 ${OBJECTDIR}/MCAL_layer/GPIO/hal_gpio.p1 ${OBJECTDIR}/MCAL_layer/device_config.p1 ${OBJECTDIR}/application.p1 ${OBJECTDIR}/ECU_layer/Keypad/keypad.p1

# Source Files
SOURCEFILES=ECU_layer/7_segment/segment.c ECU_layer/Button/Button.c ECU_layer/DC_motor/DC_motor.c ECU_layer/LED/ecu_led.c ECU_layer/project_1/project1.c ECU_layer/Relay/Relay.c MCAL_layer/GPIO/hal_gpio.c MCAL_layer/device_config.c application.c ECU_layer/Keypad/keypad.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/MPLAPprojects.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
